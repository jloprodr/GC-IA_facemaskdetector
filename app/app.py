...
#@app.route('/00e65451-2e8b-42a4-a9bd-7bfe2ee1ef7e#/image', methods=['POST'])
#@app.route('/00e65451-2e8b-42a4-a9bd-7bfe2ee1ef7e#/image/nostore', methods=['POST'])
#@app.route('/00e65451-2e8b-42a4-a9bd-7bfe2ee1ef7e#/classify/iterations/FaceMaskDetector/image', methods=['POST'])
#@app.route('/00e65451-2e8b-42a4-a9bd-7bfe2ee1ef7e#/classify/iterations/FaceMaskDetector/image/nostore', methods=['POST'])
#@app.route('/00e65451-2e8b-42a4-a9bd-7bfe2ee1ef7e#/detect/iterations/FaceMaskDetector/image', methods=['POST'])
#@app.route('/00e65451-2e8b-42a4-a9bd-7bfe2ee1ef7e#/detect/iterations/FaceMaskDetector/image/nostore', methods=['POST'])
